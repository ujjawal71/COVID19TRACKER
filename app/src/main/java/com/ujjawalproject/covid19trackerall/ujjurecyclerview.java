...
public class ujjurecyclerview  extends BaseAdapter {


    Activity context;
    ArrayList<allcountry> allCountriesResults;
    LayoutInflater inflater;

    public ujjurecyclerview(Activity context, ArrayList<allcountry> allCountriesResults) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
        {
            convertView = inflater.inflate(R.layout.ujjurecyclerview, null);
